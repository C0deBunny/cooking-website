...
function SidebarMenuButton({
  ...
  const button = (
    // data-active is omitted rather than set to false: the data-active: variants below compile to
    // [data-active], so a rendered data-active="false" would match and style every row as active.
    <Comp
